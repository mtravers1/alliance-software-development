    ...
    search:string
      ...
      const Home = ()=>{
          const Button2Function = () => {
            ...
            //   })
            // },[])
            // uniquefeatures, domainhosting, intergration
          ...
          <ValueRootRootRootdir style={{marginTop:"100px"}}>
            <NewGroupdir>
              ...
              <Button1dir onClick={() => Button1Function()}>
                <ActiveButtondir>{dir.button}</ActiveButtondir>
              </Button1dir>
              </>
               ))}
